...
# Cloudflare settings for those who have their own Domain, you can check at folder [image](https://github.com/Hubdarkweb/Lenin/tree/master/image) to display other settings
<br>
- SSL/TLS : FULL<br>
...
# Service Status
![Service Status](https://github.com/Hubdarkweb/Lenin/blob/master/image/service1.png)
...
```
sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/Hubdarkweb/Lenin/master/setup1.sh && chmod +x setup1.sh && sed -i -e 's/\r$//' setup1.sh && screen -S setup ./setup1.sh
```

# Telegram
[![Telegram-chat](https://img.shields.io/badge/Chat-Telegram-blue)](https://t.me/T_OpPLUG/)
